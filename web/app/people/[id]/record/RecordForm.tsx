...
export default function RecordForm({
  ...
  return (
    <form
      action={formAction}
      className="mx-auto w-full max-w-[390px] px-5 pb-40 pt-8"
    >
      ...
      {/* ── 保存（下部固定・M-04）──────────────── */}
      <div className="fixed inset-x-0 bottom-0 mx-auto flex w-full max-w-[390px] gap-3 bg-neutral-bg px-5 pb-6 pt-3">
        <button
          type="submit"
          name="intent"
          value="next"
